...
function cdp_load_countries(modal) {
  $("#country" + modal)
    .select2({
      ajax: {
        url: "/logistics.monrespro.com/ajax/select2_countries.php",
        dataType: "json",
...
function cdp_load_states(modal) {
  ...
  $("#state" + modal)
    .select2({
      ajax: {
        url: "/logistics.monrespro.com/ajax/select2_states.php?id=" + country,
        dataType: "json",
...
function cdp_load_cities(modal) {
  ...
  $("#city" + modal).select2({
    ajax: {
      url: "/logistics.monrespro.com/ajax/select2_cities.php?id=" + state,
      dataType: "json",
      delay: 250,
      data: function (params) {
        return {
...
$("#invoice_form").on("submit", function (event) {
  ...
  if (prealert_id) {
    data.append("prealert_id", prealert_id);
  }
  ...
  $.ajax({
    type: "POST",
    url: "/logistics.monrespro.com/ajax/customers_packages/add_customers_packages_from_prealert_ajax.php",
    data: data,
    contentType: false,
    dataType: "json",
    ...
    error: function (xhr, status, error) {
      ...
      Swal.fire({
        title: "Erreur",
        text: "La requête d'enregistrement a échoué.",
        icon: "error",
        confirmButtonColor: "#336aea",
      });
      console.error("create shipment ajax error", status, error, xhr.responseText);
    },
    complete: function () {
      $("#create_invoice").attr("disabled", false);
    },
...
function cdp_select2_init_sender() {
  if ($("#sender_id").hasClass("select2-hidden-accessible")) {
    $("#sender_id").select2("destroy");
  }
  $("#sender_id").select2({
    ajax: {
      url: "/logistics.monrespro.com/ajax/select2_sender.php",
      dataType: "json",
      delay: 250,
      data: function (params) {
        return {
...
function cdp_select2_init_sender_address() {
  var sender_id = $("#sender_id").val();
  if ($("#sender_address_id").hasClass("select2-hidden-accessible")) {
    $("#sender_address_id").select2("destroy");
  }
  $("#sender_address_id").select2({
    ajax: {
      url: "/logistics.monrespro.com/ajax/select2_sender_addresses.php?id=" + sender_id,
      dataType: "json",
      delay: 250,
      data: function (params) {
        return {
...
$("#add_user_from_modal_shipments").on("submit", function (event) {
  ...
  if (iti.isValidNumber()) {
    ...
    $.ajax({
      type: "POST",
      url: "/logistics.monrespro.com/ajax/courier/add_users_ajax.php?sender=" + sender_id,
      data: parametros,
...
$("#add_address_users_from_modal_shipments").on("submit", function (event) {
  ...
  $.ajax({
    type: "POST",
    url: "/logistics.monrespro.com/ajax/courier/add_address_users_ajax.php?sender=" + sender_id,
    data: parametros,
    success: function (response) {
      if (response.status === "success") {
        Swal.fire({
...
function cdp_validateTrackNumber(value, trackDigits) {
  ...
  $.ajax({
    type: "POST",
    dataType: "json",
    url: "/logistics.monrespro.com/ajax/validate_track_number_customer_package.php?track=" + value,
    success: function (data) {
