...
function cdp_addPaymentPayPalSuccess(details) {
  $.ajax({
    url:
      "./ajax/consolidate/add_payment_paypal_method_ajax.php?order_id=" +
      consolidate_id +
      "&track_order=" +
      track_order +
      "&customer=" +
...
if (active_stripe == 1) {
  ...
  function cdp_addPaymentStripeSuccess(details) {
    $.ajax({
      url:
        "./ajax/consolidate/add_payment_stripe_method_success_ajax.php?order_id=" +
        consolidate_id +
        "&track_order=" +
        track_order +
        "&customer=" +
...
$("#add_charges").on("submit", function (event) {
  ...
  $.ajax({
    type: "POST",
    url:
      "./ajax/consolidate/consolidate_add_payment_doc_ajax.php?order_id=" +
      consolidate_id,
    data: data,
...
if (active_paystack == 1) {
  ...
  function cdp_addPaymentPaystackSuccess(details) {
    ...
    $.ajax({
      url:
        "./ajax/consolidate/add_payment_paystack_method_success_ajax.php?order_id=" +
        consolidate_id +
        "&track_order=" +
        track_order +
        "&customer=" +
