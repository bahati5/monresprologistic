...
$lang = array(
	...
	"messagesform109" 			=> "Package updated",
	"messagesform110" 			=> "Almost ready to send",
	"messagesform111" 			=> "Use automatic pricing",
	"messagesform112" 			=> "Manual rate",
	...
	"notification_shipment13" => "The shipment has been delivered, please check it",
	...
	"help-text1" => "About",
	"help-text2" => "MONRESPRO pro is a package and transport management software, developed in PHP and PDO",
	...
	"help-text6" => "Greetings! MONRESPRO pro is up to date.",
	...
	"left-menu-sidebar-30" => "Users",
	"left-menu-sidebar-31" => "Client List",
	"left-menu-sidebar-32" => "List of Drivers",

	"left-menu-sidebar-33" => "Account Profile",
	"left-menu-sidebar-34" => "User Manager",
	"left-menu-sidebar-35" => "Create new user",
	...
	"leftorder17714" => "Price list calculation",
	...
	"tools-config22" => "Log notification Admin",
	...
	"ws-add-text30" => "ClickSend API Configuration",

	"ws-add-text26" => "Default notification templates",
	"ws-add-text27" => "Notification templates",
	"ws-add-text28" => "Email",
	"ws-add-text29" => "WhatsApp",
	"ws-add-text31" => "Activate ClickSend API",
	"ws-add-text32" => "Configure SMS ClickSend",
);
