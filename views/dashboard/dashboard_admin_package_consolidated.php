...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix ">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-header-title d-flex justify-content-between">
                                    <div class="card-title mb-6">
                                        <h5 class="m-0 me-2"><?php echo $lang['messagesform106'] ?></h5>
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-info-statics">
                                                <?php
                                                $db->cdp_query('SELECT COUNT(*) as total FROM cdb_consolidate_packages');
                                                $db->cdp_execute();
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-info-statics">
                                                <?php
                                                $db->cdp_query('SELECT COUNT(*) as total FROM cdb_consolidate_packages WHERE status_courier=8');
                                                $db->cdp_execute();
                                                $count = $db->cdp_registro();
                                                echo $count->total;
                                                ?>                      
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-info-statics">
                                                <?php
                                                $db->cdp_query('SELECT COUNT(*) as total FROM cdb_consolidate_packages WHERE status_invoice=2');
                                                $db->cdp_execute();
                                                $count = $db->cdp_registro();
                                                echo $count->total;
                                                ?>                      
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-info-statics">
                                                <?php
                                                $db->cdp_query('SELECT COUNT(*) as total FROM cdb_consolidate_packages WHERE status_invoice=3');
                                                $db->cdp_execute();
                                                $count = $db->cdp_registro();
                                                echo $count->total;
                                                ?>                      
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <div class="d-flex align-items-center">
                                            <div class="m-r-10">
                                                <a href="payments_gateways_package_consolidate_list.php">
                                            ...
                                            <div class="card-info-statics">
                                              <h5 class="mb-0">
                                                ...
                                                <?php
                                                $db->cdp_query("SELECT IFNULL(SUM(total_order), 0) as total FROM cdb_consolidate_packages ");
                                                $db->cdp_execute();
                                                $count = $db->cdp_registro();
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><?php echo $lang['messagesform105'] ?></h4>
    ...
    <script src="dataJs/dashboard_consolidate_package.js"></script>
