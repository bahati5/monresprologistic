                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h3 class="card-title"><span><?php echo $lang['tools-methodpay7'] ?></span></h3>
                                    </div>
                                </div>
                                <div><hr><br></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="met_payment" id="met_payment" placeholder="<?php echo $lang['tools-methodpay6'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="lastName1"><?php echo $lang['tools-methodpay1123'] ?></label>
                                                    <input type="number" class="form-control required" name="detail" id="detail" placeholder="<?php echo $lang['tools-methodpay1123'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
