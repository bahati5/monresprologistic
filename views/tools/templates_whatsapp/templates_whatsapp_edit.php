										...
										<form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
											...
											<section>
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															...
															<input type="text" class="form-control required" name="title" id="title" value="<?php echo $row->title; ?>" placeholder="<?php echo $lang['tools-template3'] ?>">
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<label for="lastName1"><?php echo $lang['ws-add-text11'] ?></label>
															<textarea type="text" class="form-control required" name="description" id="description" rows="2"><?php echo $row->description; ?></textarea>
														</div>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-md-12">
														...
														<div class="form-group">
															...
															<textarea type="text" class="form-control required" name="body" id="body" rows="8"><?php echo $row->body; ?></textarea>
														</div>
													</div>
												</div>
