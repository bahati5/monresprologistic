                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h3 class="card-title"><span> <?php echo $lang['tools-shipmode7'] ?></span></h3>
                                    </div>
                                </div>
                                <div><hr><br></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="delitime" id="delitime" placeholder="Delivery time">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="lastName1"><?php echo $lang['tools-shipmode8'] ?></label>
                                                    <input type="text" class="form-control required" name="detail" id="detail" placeholder="Detail delivery time">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
