                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" id="update_data_paystack" name="update_data_paystack" method="post">

                                    <section>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="firstName1"><?php echo $lang['tools-config114'] ?></label>
                                                    <input type="text" class="form-control required" name="name_pay" value="<?php echo $row_off->name_pay; ?>" placeholder="<?php echo $lang['tools-config114'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="lastName1"><?php echo $lang['tools-config114'] ?></label>
                                                    <input type="text" class="form-control required" name="detail_pay" value="<?php echo $row_off->detail_pay; ?>" placeholder="<?php echo $lang['tools-config114'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="firstName1"><?php echo $lang['tools-config121'] ?></label>
                                                    <input type="text" class="form-control required" name="public_key" value="<?php echo $row_off->public_key; ?>" placeholder="<?php echo $lang['tools-config121'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="lastName1"><?php echo $lang['tools-config122'] ?></label>
                                                    <input type="text" class="form-control required" name="secret_key" value="<?php echo $row_off->secret_key; ?>" placeholder="<?php echo $lang['tools-config122'] ?>">
                                                </div>
                                            </div>
                                        </div>
