                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" id="update_data_stripe" name="update_data_stripe" method="post">
                                    ...
                                    <section>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="lastName1"><?php echo $lang['tools-config115'] ?></label>
                                                    <input type="text" class="form-control required" name="detail_pay" value="<?php echo $row_off->detail_pay; ?>" placeholder="<?php echo $lang['tools-config115'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="lastName1"><?php echo $lang['tools-config112'] ?></label>
