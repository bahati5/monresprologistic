                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="name_pack" id="name_pack" placeholder="<?php echo $lang['tools-packaging6'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="lastName1"><?php echo $lang['tools-packaging8'] ?></label>
                                                    <textarea class="form-control required" rows="2" type="text" name="detail_pack" id="detail_pack" placeholder="<?php echo $lang['tools-packaging8'] ?>"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
