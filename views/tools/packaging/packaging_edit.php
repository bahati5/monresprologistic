...
if (isset($_GET['id'])) {
    $data = cdp_getPackagingEdit($_GET['id']);
}

if (!isset($_GET['id']) or $data['rowCount'] != 1) {
    cdp_redirect_to("packaging_list.php");
}
                                ...
                                <form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="name_pack" id="name_pack" value="<?php echo $row_pack->name_pack; ?>" placeholder="<?php echo $lang['tools-packaging1'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="lastName1"><?php echo $lang['tools-packaging3'] ?></label>
                                                    <textarea class="form-control required" rows="2" type="text" name="detail_pack" id="detail_pack" placeholder="<?php echo $lang['tools-packaging3'] ?>"><?php echo $row_pack->detail_pack; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <a href="packaging_list.php" class="btn btn-outline-secondary btn-confirmation"><span><i class="ti-share-alt"></i></span> <?php echo $lang['global-buttons-3'] ?></a>
                                        </div>
                                    </div>
