...
<head>
    ...
    <title><?php echo $lang['report-text1'] ?></title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12">
                        ...
                        <div class="card card-outline" style="border-top: 3px solid #bbb">
                            <h4 class="card-title  ml-4 mt-3"> <?php echo $lang['report-text1'] ?></h4>
                                    ...
                                    <div class=" col-sm-12 col-md-2 mb-2">
                                        <div class="input-group">
                                            <select onchange="cdp_load(1);" class="form-control custom-select " id="status_courier" name="status_courier">
                                                <option value="0"><?php echo $lang['report-text2'] ?></option>
                                    ...
                                    <div class=" col-sm-12 col-md-2 mb-2">
                                        <div class="input-group">
                                            <select onchange="cdp_load(1);" class="form-control custom-select " id="agency" name="agency">
                                                <option value="0"><?php echo $lang['report-text3'] ?></option>
                                    ...
                                    <div class=" col-sm-12 col-md-2 mb-2">
                                        <div class="input-group">
                                            <select onchange="cdp_load(1);" class="form-control custom-select " id="method" name="method">
                                                <option value="0"><?php echo $lang['report-text4'] ?></option>
