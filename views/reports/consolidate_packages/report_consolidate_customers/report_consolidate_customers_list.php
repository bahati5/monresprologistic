...
<head>
    ...
    <title><?php echo $lang['report-text80'] ?></title>
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12">
                        ...
                        <div class="card card-outline" style="border-top: 3px solid #bbb;">
                            <h4 class="card-title  ml-4 mt-3"> <?php echo $lang['report-text80'] ?></h4>
    ...
    <script src="dataJs/report_consolidate_packages_customers.js"></script>
