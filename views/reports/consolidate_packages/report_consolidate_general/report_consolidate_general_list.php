...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12">
                        ...
                        <div class="card card-outline" style="border-top: 3px solid #bbb;">
                            <h4 class="card-title  ml-4 mt-3"> <?php echo $lang['report-text76'] ?></h4>
                                    ...
                                    <div class=" col-sm-12 col-md-2 mb-2">
                                        <div class="input-group">
                                            <select onchange="cdp_load(1);" class="form-control custom-select " id="agency" name="agency">
                                                <option value="0"><?php echo $lang['report-text60'] ?></option>
    ...
    <script src="dataJs/report_consolidate_packages_general.js"></script>
</body>
