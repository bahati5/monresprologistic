...
<body>
	<div id="page-wrap">
		...
		<div class="container_etiqueta" style="min-height: 540px; max-height: 540px; min-width: 420px; max-width: 420px;">
			...
			<div><br><br></div>
			<div class="app_easypack_ticket_zebra" style="font-size: 37px; padding-top:20px; margin-top: 1px; margin-left: 0px; ">
				<strong><?php echo $address_order->recipient_country . " - " . $address_order->recipient_city; ?></strong>
			</div>
			<div class="app_easypack_qr" style="display: flex; padding-top:20px; align-items: center; max-height: 110px; min-height: 110px;">
		...
		<button class='button -dark center no-print' onClick="window.print();" style="font-size:16px; ">
			<?php echo $lang['inv-label9'] ?> &nbsp;&nbsp;
			<li class="fa fa-print"></i>
		</button>
	</div>
</body>
