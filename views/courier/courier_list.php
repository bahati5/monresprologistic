        ...
        <div class="page-wrapper">
            <div class="tw-p-4 lg:tw-p-6 tw-space-y-4">
                ...
                <div class="tw-flex tw-flex-col sm:tw-flex-row sm:tw-items-center sm:tw-justify-between tw-gap-3">
                    <h1 class="tw-text-2xl tw-font-bold tw-text-gray-800"><?php echo $lang['shiplist']; ?></h1>
                    <?php $add_courier_url = ($userData->userlevel == 9) ? "courier_add.php" : "courier_add_client.php"; ?>
                    <a href="<?php echo $add_courier_url; ?>" class="tw-inline-flex tw-items-center tw-gap-2 tw-px-4 tw-py-2 tw-bg-blue-600 tw-text-white tw-rounded-lg tw-text-sm tw-font-medium hover:tw-bg-blue-700 tw-transition-colors tw-shadow-sm">
                ...
                <div class="tw-bg-white tw-rounded-xl tw-border tw-border-gray-200 tw-shadow-sm tw-p-4">
                    ...
                    <div class="tw-flex tw-flex-col md:tw-flex-row tw-gap-3 tw-mb-4">
                        ...
                        <select onchange="cdp_load(1);" id="filterby" name="filterby"
                                class="tw-px-3 tw-py-2 tw-border tw-border-gray-200 tw-rounded-lg tw-text-sm tw-bg-white focus:tw-ring-2 focus:tw-ring-blue-500 tw-outline-none tw-min-w-[160px]">
                    ...
                    <!-- Bulk actions (hidden by default, toggled by JS) -->
                        ...
                        <div class="tw-relative">
                            ...
                            <div x-show="open" @click.outside="open = false" x-transition
                                ...
                                <a href="#" data-toggle="modal" data-target="#modalCheckboxStatus" class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-text-sm tw-text-gray-700 hover:tw-bg-gray-50">
                                    <i data-lucide="refresh-cw" class="tw-w-3.5 tw-h-3.5 tw-text-green-500"></i>
                                ...
                                <a href="#" data-toggle="modal" data-target="#modalDriverCheckbox" class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-text-sm tw-text-gray-700 hover:tw-bg-gray-50">
                                    <i data-lucide="truck" class="tw-w-3.5 tw-h-3.5 tw-text-red-500"></i>
                                ...
                                <a onclick="cdp_printMultipleLabel();" class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-text-sm tw-text-gray-700 hover:tw-bg-gray-50 tw-cursor-pointer">
                                    <i data-lucide="printer" class="tw-w-3.5 tw-h-3.5 tw-text-gray-500"></i>
