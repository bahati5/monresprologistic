...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-12 mx-auto text-center mt-4">
                                        ...
                                        <h4><span><?php echo $lang['leftorder132']; ?> : <b><?php echo  $row_order->total_order; ?> <?php echo $core->currency; ?> </b></span></h4>
    ...
    <input id="order_total_order" name="order_total_order" type="hidden" value="<?php echo $row_order->total_order; ?>" />
