        ...
        <div class="page-wrapper">
            ...
            <div class="tw-px-6 tw-py-5">
                ...
                <div class="tw-flex tw-items-center tw-gap-3 tw-mb-5">
                    <div class="tw-w-10 tw-h-10 tw-rounded-xl tw-bg-amber-600 tw-flex tw-items-center tw-justify-center tw-shadow-sm">
                        <i data-lucide="package-check" class="tw-w-5 tw-h-5 tw-text-white"></i>
                    </div>
                    <div>
                        <h1 class="tw-text-xl tw-font-bold tw-text-gray-900"><?php echo $lang['leftorder73'] ?></h1>
                        <p class="tw-text-sm tw-text-gray-500"><?php echo $lang['edit-courier1'] ?? 'Modifier le bordereau'; ?> — <?php echo $row_order->order_prefix . $row_order->order_no; ?></p>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><i data-lucide="user" class="tw-w-4 tw-h-4"></i> <?php echo $lang['langs_010']; ?></h4>
                                    <hr>
                                    ...
                                    ?>
                                        <label class="custom-control custom-checkbox" style="font-size: 18px; padding-left: 0px">
                                            ...
                                            <b>
                                                ...
                                                <i data-lucide="mail" class="tw-w-5 tw-h-5 tw-text-green-500" style="display:inline-block;vertical-align:middle"></i>
                                            </b>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><i data-lucide="user" class="tw-w-4 tw-h-4"></i> <?php echo $lang['left334']; ?></h4>
                                    <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-2">
                                        ...
                                        <label class="custom-control custom-checkbox">
                                            <?php echo $lang['messagesform112'] ?> <input type="checkbox" class="custom-control-input" name="tariff_mode" id="tariff_mode" value="1" <?php if ($row_order->manual_tariff === 1) {
                                                                                                                                                            echo 'checked';
                                                                                                                                                        } ?>>
                                            <span class="custom-control-indicator"></span>
                                        </label>
