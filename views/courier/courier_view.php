                                    ...
                                    <table class="table table-hover" id="tabla">
                                        ...
                                        <tbody id="projects-tbl">
                                            ...
                                            ?>
                                                ...
                                                if ($row_order->manual_tariff == 1) {
                                                    $sumador_total = $calculate_weight * (float)$row_order->value_weight; // Calculate total based on weight and price per lb
                                                } else {
                                                     $sumador_total = (float)$row_order->value_weight; // Calculate total based on weight and price per lb
                                                }
