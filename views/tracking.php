...
<head>
    ...
    <!-- Bootstrap -->
    <link href="assets/css_main_monrespro/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- Icons -->
    <link href="assets/css_main_monrespro/css/materialdesignicons.min.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="https://unicons.iconscout.com/release/v3.0.6/css/line.css">
    <!-- Slider -->
    <link rel="stylesheet" href="assets/css_main_monrespro/css/tiny-slider.css" />
    <!-- Date picker -->
    <link rel="stylesheet" href="assets/css_main_monrespro/css/datepicker.min.css">
    <!-- Main Css -->
    <link href="assets/css_main_monrespro/css/style.css" rel="stylesheet" type="text/css" id="theme-opt" />
    <link href="assets/css_main_monrespro/css/colors/default.css" rel="stylesheet" id="color-opt">
...
<body class="cover-user">
    ...
    <!-- Hero Start -->
    <section class="bg-half-170 d-table w-100 h-100" style="background: url('assets/css_main_monrespro/images/user/bg.jpg') center center;">
    ...
    <!-- javascript -->
    <script src="assets/css_main_monrespro/main_MONRESPRO/js/jquery.min.js"></script>
    <script src="assets/css_main_monrespro/js/bootstrap.bundle.min.js"></script>
    <!-- SLIDER -->
    <script src="assets/css_main_monrespro/js/tiny-slider.js "></script>
    <!-- Datepicker -->
    <script src="assets/css_main_monrespro/js/datepicker.min.js"></script>
    <!-- Icons -->
    <script src="assets/css_main_monrespro/js/feather.min.js"></script>
    <!-- Main Js -->
    <script src="assets/css_main_monrespro/js/plugins.init.js"></script>
    <!--Note: All init js like tiny slider, counter, countdown, maintenance, lightbox, gallery, swiper slider, aos animation etc.-->
    <script src="assets/css_main_monrespro/js/app.js"></script>
