...
<head>
    ...
    <title><?php echo $lang['leftorder315'] ?> | <?php echo $core->site_name ?></title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h3 class="card-title"><?php echo $lang['leftorder315'] ?></h3>
                                    </div>
                                </div>
                                <div><hr><br></div>
                                ...
                                <form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
                                    ...
                                    <section>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row_off->name; ?>" type="text" class="form-control required" name="name" id="name" placeholder="<?php echo $lang['leftorder303'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row_off->iso3; ?>" type="text" class="form-control required" name="iso3" id="iso3" placeholder="<?php echo $lang['leftorder304'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row_off->region; ?>" type="text" class="form-control required" name="region" id="region" placeholder="<?php echo $lang['leftorder305'] ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row_off->capital; ?>" type="text" class="form-control required" name="capital" id="capital" placeholder="<?php echo $lang['leftorder312'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row_off->phone_code; ?>" type="text" class="form-control required" name="phone_code" id="phone_code" placeholder="<?php echo $lang['leftorder313'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row_off->currency_name; ?>" type="text" class="form-control required" name="currency_name" id="currency_name" placeholder="<?php echo $lang['leftorder306'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row_off->currency_symbol; ?>" type="text" class="form-control required" name="currency_symbol" id="currency_symbol" placeholder="<?php echo $lang['leftorder307'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="firstName1"><?php echo $lang['leftorder316'] ?></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-outline-primary btn-confirmation" name="dosubmit" type="submit"><?php echo $lang['leftorder315'] ?></i></span></button>
