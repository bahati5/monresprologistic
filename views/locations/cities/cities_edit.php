...
if (isset($_GET['id'])) {
    $data = cdp_getCity($_GET['id']);
}

if (!isset($_GET['id']) or $data['rowCount'] != 1) {
    cdp_redirect_to("cities_list.php");
}
...
<head>
    ...
    <title><?php echo $lang['leftorder331']; ?> | <?php echo $core->site_name ?></title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h3 class="card-title"><?php echo $lang['leftorder331']; ?></h3>
                                    </div>
                                </div>
                                <div><hr><br></div>
                                ...
                                <form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
                                    ...
                                    <section>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                ...
                                                <div class="input-group">
                                                    <select class="select2 form-control custom-select" id="state" name="state">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row->name; ?>" type="text" class="form-control required" name="city_name" id="city_name" placeholder="<?php echo $lang['leftorder330']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-outline-primary btn-confirmation" name="dosubmit" type="submit"><?php echo $lang['leftorder331']; ?></i></span></button>
