		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel"><i data-lucide="package" class="tw-w-4 tw-h-4 tw-text-blue-600" style="display:inline-block;vertical-align:middle;margin-right:4px"></i> <?php echo $lang['leftorder148']; ?>
					</h4>
