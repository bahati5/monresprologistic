		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel"><i data-lucide="check-circle" class="tw-w-4 tw-h-4 tw-text-green-600" style="display:inline-block;vertical-align:middle;margin-right:4px"></i> <?php echo $lang['modal-text31'] ?></h4>
