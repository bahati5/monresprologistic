		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel"><i data-lucide="trash-2" class="tw-w-4 tw-h-4 tw-text-red-500" style="display:inline-block;vertical-align:middle;margin-right:4px"></i> Delete Courier package</h4>
