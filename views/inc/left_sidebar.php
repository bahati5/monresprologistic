<?php include __DIR__ . '/left_sidebar_onepanel.php'; ?>

<!-- Legacy sidebar (hidden, kept for JS compatibility with sidebarmenu.js) -->
<aside class="left-sidebar" style="display:none !important; width:0 !important; overflow:hidden !important;">
	<!-- Sidebar scroll-->
					...
					<li class="sidebar-item">
						...
						<li class="sidebar-item">
							...
							<ul aria-expanded="false" class="collapse  first-level">
								...
								<li class="sidebar-item">
									<a class="sidebar-link waves-effect waves-dark" href="agency_payment_coordinates_list.php">
										<i class="mdi mdi-bank" style="color:#fc3f7"></i>
										<span class="hide-menu"> Coordonnées paiement (agences)</span>
									</a>
								</li>
							</ul>
						</li>
