...
if (isset($_POST["create_invoice"])) {
    ...
    if ($db->cdp_execute()) {
        ...
        $success_script = 'swal("¡Success!", "' . $message . '", "success").then(function() { window.location.href = "consolidate_package_view.php?id=' . $order_id . '"; });';
    } else {
            ...
            <div class="tw-bg-gradient-to-r tw-from-blue-600 tw-to-indigo-700 tw-rounded-2xl tw-shadow-lg tw-mx-4 tw-mt-4 tw-mb-6 tw-p-6 tw-flex tw-items-center tw-justify-between tw-flex-wrap tw-gap-4">
                <div class="tw-flex tw-items-center tw-gap-4">
                    <div class="tw-bg-white/20 tw-rounded-xl tw-p-3">
                        <i data-lucide="package-plus" class="tw-w-7 tw-h-7 tw-text-white"></i>
                    </div>
                    <div>
                        <h1 class="tw-text-xl tw-font-bold tw-text-white tw-leading-tight"><?php echo $lang['langs_01']; ?></h1>
                        <p class="tw-text-blue-100 tw-text-sm tw-mt-0.5"><?php echo $order_prefix; ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="tw-mx-4 tw-mb-6">
                <div class="tw-flex tw-items-center tw-justify-between tw-gap-2 tw-bg-white tw-rounded-xl tw-shadow-sm tw-p-3 tw-overflow-x-auto">
                    ...
                    <a href="#step-parties" class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-blue-50 tw-text-blue-700 tw-font-medium tw-text-xs tw-no-underline hover:tw-bg-blue-100 tw-transition tw-whitespace-nowrap">
                        ...
                        <?php echo $lang['langs_010'] ?? 'Exp.'; ?> & <?php echo $lang['left334'] ?? 'Dest.'; ?>
                    </a>
                    <div class="tw-h-px tw-w-8 tw-bg-gray-200 tw-flex-shrink-0"></div>
            ...
            <form method="post" id="invoice_form" name="invoice_form" enctype="multipart/form-data">
                ...
                <div class="container-fluid">
                    ...
                    <div class="tw-flex tw-items-center tw-gap-2 tw-mb-3 tw-mt-2 tw-px-1">
                        ...
                        <h2 class="tw-text-xs tw-font-semibold tw-text-gray-500 tw-uppercase tw-tracking-wider"><?php echo $lang['langs_010'] ?? 'Exp.'; ?> & <?php echo $lang['left334'] ?? 'Dest.'; ?></h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                        <label class="custom-control custom-checkbox" style="font-size: 18px; padding-left: 0px">
                                            ...
                                            <b><?php echo $lang['leftorder14444']; ?> <i data-lucide="mail" class="tw-w-5 tw-h-5" style="display:inline-block;vertical-align:middle;color:#07bc4c"></i></b>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group-append input-sm">
                                                        <button disabled id="add_address_sender" data-type_user="user_customer" data-toggle="modal" data-target="#myModalAddUserAddresses" type="button" class="btn btn-default"><i data-lucide="plus" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><i data-lucide="users" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle;color:#36bea6"></i> <?php echo $lang['left334']; ?></h4>
                                    <hr>
                                    ...
                                    ?>
                                        <label class="custom-control custom-checkbox" style="font-size: 18px; padding-left: 0px">
                                            ...
                                            <b>Notify by SMS <i data-lucide="mail" class="tw-w-5 tw-h-5" style="display:inline-block;vertical-align:middle;color:#07bc4c"></i></b>
                                            <span class="custom-control-indicator"></span>
                                        </label>
                                    <?php } ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group-append input-sm">
                                                        <button disabled id="add_recipient" type="button" data-type_user="user_recipient" data-toggle="modal" data-target="#myModalAddRecipient" class="btn btn-default"><i data-lucide="plus" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group-append input-sm">
                                                        <button disabled id="add_address_recipient" type="button" data-type_user="user_recipient" data-toggle="modal" data-target="#myModalAddRecipientAddresses" class="btn btn-default"><i data-lucide="plus" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tw-flex tw-items-center tw-gap-2 tw-mb-3 tw-mt-2 tw-px-1">
                        ...
                        <h2 class="tw-text-xs tw-font-semibold tw-text-gray-500 tw-uppercase tw-tracking-wider"><?php echo $lang['add-title13'] ?? 'Détails'; ?></h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-append" data-target="#datetimepicker1" data-toggle="datetimepicker">
                                                    <div class="input-group-text"><i data-lucide="calendar" class="tw-w-4 tw-h-4 tw-text-red-500" style="display:inline-block;vertical-align:middle"></i></div>
                                                </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputEmail3" class="control-label col-form-label"><?php echo $lang['add-title23'] ?> <i data-lucide="credit-card" class="tw-w-4 tw-h-4 tw-text-red-500" style="display:inline-block;vertical-align:middle"></i></label>
                                            <div class="input-group mb-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputcontact" class="control-label col-form-label"><?php echo $lang['add-title19'] ?> <i data-lucide="truck" class="tw-w-4 tw-h-4 tw-text-red-500" style="display:inline-block;vertical-align:middle"></i></label>
                                            <div class="input-group mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <button type="button" id="openMultiFile" class="btn btn-default  pull-left  mb-4"> <i data-lucide="paperclip" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i>
                    ...
                    <!-- ===== STEP 4: Articles / Colis ===== -->
                    <div id="step-items" class="tw-scroll-mt-20">
                    <div class="tw-flex tw-items-center tw-gap-2 tw-mb-3 tw-mt-2 tw-px-1">
                        <i data-lucide="package" class="tw-w-4 tw-h-4 tw-text-blue-600"></i>
                                        ...
                                        <table id="invoice-item-table" class="table">
                                            <div align="right">
                                                <button type="button" data-toggle="modal" data-target="#myModalConsolidate" class="btn btn-outline-success mb-2">
                                                    <i data-lucide="search" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i>
