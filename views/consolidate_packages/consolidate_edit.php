...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="tw-bg-gradient-to-r tw-from-blue-600 tw-to-indigo-700 tw-rounded-2xl tw-shadow-lg tw-mx-4 tw-mt-4 tw-mb-6 tw-p-6 tw-flex tw-items-center tw-justify-between tw-flex-wrap tw-gap-4">
                <div class="tw-flex tw-items-center tw-gap-4">
                    <div class="tw-bg-white/20 tw-rounded-xl tw-p-3">
                        <i data-lucide="package-open" class="tw-w-7 tw-h-7 tw-text-white"></i>
                    </div>
                    <div>
                        <h1 class="tw-text-xl tw-font-bold tw-text-white tw-leading-tight"><?php echo $lang['langs_01']; ?></h1>
                        <p class="tw-text-blue-100 tw-text-sm tw-mt-0.5"><?php echo $row_order->c_prefix . $row_order->c_no; ?></p>
                    </div>
                </div>
            </div>
            <!-- ===== Visual Stepper ===== -->
            <div class="tw-mx-4 tw-mb-6">
                <div class="tw-flex tw-items-center tw-justify-between tw-gap-2 tw-bg-white tw-rounded-xl tw-shadow-sm tw-p-3 tw-overflow-x-auto">
                    <a href="#step-tracking" class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-blue-50 tw-text-blue-700 tw-font-medium tw-text-xs tw-no-underline hover:tw-bg-blue-100 tw-transition tw-whitespace-nowrap">
                        <span class="tw-bg-blue-600 tw-text-white tw-rounded-full tw-w-5 tw-h-5 tw-flex tw-items-center tw-justify-center tw-text-[10px] tw-font-bold">1</span>
                        Tracking
                    </a>
                    <div class="tw-h-px tw-w-8 tw-bg-gray-200 tw-flex-shrink-0"></div>
                    <a href="#step-parties" class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-blue-50 tw-text-blue-700 tw-font-medium tw-text-xs tw-no-underline hover:tw-bg-blue-100 tw-transition tw-whitespace-nowrap">
                        <span class="tw-bg-blue-600 tw-text-white tw-rounded-full tw-w-5 tw-h-5 tw-flex tw-items-center tw-justify-center tw-text-[10px] tw-font-bold">2</span>
                        <?php echo $lang['langs_010'] ?? 'Parties'; ?>
                    </a>
                    <div class="tw-h-px tw-w-8 tw-bg-gray-200 tw-flex-shrink-0"></div>
                    <a href="#step-details" class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-blue-50 tw-text-blue-700 tw-font-medium tw-text-xs tw-no-underline hover:tw-bg-blue-100 tw-transition tw-whitespace-nowrap">
                        <span class="tw-bg-blue-600 tw-text-white tw-rounded-full tw-w-5 tw-h-5 tw-flex tw-items-center tw-justify-center tw-text-[10px] tw-font-bold">3</span>
                        <?php echo $lang['add-title13'] ?? 'Details'; ?>
                    </a>
                    <div class="tw-h-px tw-w-8 tw-bg-gray-200 tw-flex-shrink-0"></div>
                    <a href="#step-items" class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-blue-50 tw-text-blue-700 tw-font-medium tw-text-xs tw-no-underline hover:tw-bg-blue-100 tw-transition tw-whitespace-nowrap">
                        <span class="tw-bg-blue-600 tw-text-white tw-rounded-full tw-w-5 tw-h-5 tw-flex tw-items-center tw-justify-center tw-text-[10px] tw-font-bold">4</span>
            ...
            <form method="post" id="invoice_form" name="invoice_form">
                <div class="container-fluid">
                    ...
                    <div class="tw-flex tw-items-center tw-gap-2 tw-mb-3 tw-px-1">
                        ...
                        <h2 class="tw-text-xs tw-font-semibold tw-text-gray-500 tw-uppercase tw-tracking-wider">Tracking</h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                    ...
                    <div class="tw-flex tw-items-center tw-gap-2 tw-mb-3 tw-mt-2 tw-px-1">
                        ...
                        <h2 class="tw-text-xs tw-font-semibold tw-text-gray-500 tw-uppercase tw-tracking-wider"><?php echo $lang['langs_010'] ?? 'Parties'; ?></h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><i data-lucide="user" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle;color:#36bea6"></i> <?php echo $lang['langs_010']; ?></h4>
                                    <hr>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group-append input-sm">
                                                        <button type="button" class="btn btn-default" data-type_user="user_customer" data-toggle="modal" data-target="#myModalAddUser"><i data-lucide="plus" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i></button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12 ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group-append input-sm">
                                                        <button id="add_address_sender" data-type_user="user_customer" data-toggle="modal" data-target="#myModalAddUserAddresses" type="button" class="btn btn-default"><i data-lucide="plus" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i></button>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><i data-lucide="user" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle;color:#36bea6"></i> <?php echo $lang['left334']; ?></h4>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group-append input-sm">
                                                        <button id="add_recipient" type="button" data-type_user="user_recipient" data-toggle="modal" data-target="#myModalAddRecipient" class="btn btn-default"><i data-lucide="plus" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i></button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group-append input-sm">
                                                        <button id="add_address_recipient" type="button" data-type_user="user_recipient" data-toggle="modal" data-target="#myModalAddRecipientAddresses" class="btn btn-default"><i data-lucide="plus" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tw-flex tw-items-center tw-gap-2 tw-mb-3 tw-mt-2 tw-px-1">
                        ...
                        <h2 class="tw-text-xs tw-font-semibold tw-text-gray-500 tw-uppercase tw-tracking-wider"><?php echo $lang['add-title13'] ?? 'Details'; ?></h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><i data-lucide="book-open" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle;color:#36bea6"></i> <?php echo $lang['add-title13'] ?></h4>
                                    <br>
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group">
                                                <select class="custom-select col-12" id="order_item_category" name="order_item_category" required>
                                                    <?php foreach ($categories as $row) : ?>
                                                        <option value="<?php echo $row->id; ?>" <?php if ($row_order->order_item_category == $row->id) { echo 'selected'; } ?>><?php echo $row->name_item; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-append" data-target="#datetimepicker1" data-toggle="datetimepicker">
                                                    <div class="input-group-text"><i data-lucide="calendar" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle;color:#ff0000"></i></div>
                                                </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputEmail3" class="control-label col-form-label"><?php echo $lang['add-title23'] ?> <i data-lucide="credit-card" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle;color:#ff0000"></i></label>
                                            <div class="input-group">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputcontact" class="control-label col-form-label"><?php echo $lang['langs_039'] ?> <i data-lucide="truck" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle;color:#ff0000"></i></label>
                                            <div class="input-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <button type="button" id="openMultiFile" class="btn btn-default  pull-left  mb-4">
                                                <i data-lucide="paperclip" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i>
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div id="clean_files" class="hide">
                                            <button type="button" id="clean_file_button" class="btn btn-danger ml-3"> <i data-lucide="trash-2" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i>
                    ...
                    ?>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title"><i data-lucide="paperclip" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i><?php echo $lang['leftorder147'] ?></h5>
                                        <hr>
                                        <div class="col-md-12 row">
                                            ...
                                            ?>
                                                ...
                                                <div class="col-md-3" id="file_delete_item_<?php echo $file->id; ?>">
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-2">
                                                            <button type="button" class="btn btn-danger btn-sm" onclick="cdp_deleteImgAttached('<?php echo $file->id; ?>');"><i data-lucide="trash-2" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php
                    ...
                    <div class="tw-flex tw-items-center tw-gap-2 tw-mb-3 tw-mt-2 tw-px-1">
                        ...
                        <h2 class="tw-text-xs tw-font-semibold tw-text-gray-500 tw-uppercase tw-tracking-wider"><?php echo $lang['left212'] ?? 'Articles'; ?></h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="invoice-item-table" class="table">
                                            <div align="right">
                                                <button type="button" data-toggle="modal" data-target="#myModalConsolidate" class="btn btn-outline-success mb-2"><i data-lucide="search" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i> Search Shipments</button>
                                            </div>
                                                ...
                                                ?>
                                                        ...
                                                        <tr class="card-hover" id="row_id_<?php echo $row_order_item->order_id; ?>">
                                                            ...
                                                            <td class="text-center">
                                                                <button type="button" name="remove_row" id="<?php echo $row_order_item->order_id; ?>" class="btn btn-danger btn-xs remove_row mt-2"><i data-lucide="trash-2" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i></button>
                                                            </td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" style="color:#ff0000"><i data-lucide="truck" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i></span>
                                                </div>
                                            ...
                                            <div class="form-actions">
                                                <div class="card-body">
                                                    <div class="text-right">
                                                        ...
                                                        <input type="button" name="create_invoice" id="create_invoice" class="btn btn-success" value="<?php echo $lang['langs_10084']; ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
