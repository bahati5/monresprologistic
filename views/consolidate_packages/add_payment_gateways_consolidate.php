...
if (isset($_GET['id_order'])) {
    $data = cdp_getConsolidatePackage($_GET['id_order']);
}
...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-12 mx-auto text-center mt-4">
                                        ...
                                        <h4><span><?php echo $lang['leftorder132']; ?>: <b><?php echo $core->currency; ?> <?php echo  cdb_money_format($row_order->total_order); ?> </b></span></h4>
    ...
    <input id="order_id" name="order_id" type="hidden" value="<?php echo $row_order->consolidate_id; ?>" />
    ...
    <script src="dataJs/consolidate_packages_add_payment_gateways.js"></script>