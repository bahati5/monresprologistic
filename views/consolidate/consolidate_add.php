...
if (isset($_POST["create_invoice"])) {
    ...
    // Add a user
    $db->cdp_query("SELECT * FROM cdb_users where id= '" . $_SESSION['userid'] . "'");
    $user_data = $db->cdp_registro();
    ...
    $db->bind(':comments', $lang['notification_shipment28'] . ' ' . $user_data->fname . ' ' . $user_data->lname);
    ...
    $db->bind(':user_id',  $_SESSION['userid']);
    $db->bind(':action', $lang['notification_shipment28']);
        ...
        <div class="page-wrapper">
            ...
            <div class="tw-px-6 tw-py-5">
                ...
                <div class="tw-flex tw-items-center tw-gap-3 tw-mb-5">
                    <div class="tw-w-10 tw-h-10 tw-rounded-xl tw-bg-indigo-600 tw-flex tw-items-center tw-justify-center tw-shadow-sm">
                        <i data-lucide="package-plus" class="tw-w-5 tw-h-5 tw-text-white"></i>
                    </div>
                    <div>
                        <h1 class="tw-text-xl tw-font-bold tw-text-gray-900"><?php echo $lang['langs_01'] ?></h1>
                        <p class="tw-text-sm tw-text-gray-500"><?php echo $lang['langs_02'] ?? 'Créer un nouveau consolidé'; ?></p>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><i data-lucide="user" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i> <?php echo $lang['langs_010']; ?></h4>
                                    <hr>
                                    ...
                                    ?>
                                        <label class="custom-control custom-checkbox" style="font-size: 18px; padding-left: 0px">
                                            ...
                                            <b><?php echo $lang['leftorder14444']; ?> <i data-lucide="mail" class="tw-w-5 tw-h-5 tw-text-green-500" style="display:inline-block;vertical-align:middle"></i></b>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><i data-lucide="user" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i> <?php echo $lang['left334']; ?></h4>
                                    <hr>
                                    ...
                                    ?>
                                        <label class="custom-control custom-checkbox" style="font-size: 18px; padding-left: 0px">
                                            ...
                                            <b>Notify by SMS <i data-lucide="mail" class="tw-w-5 tw-h-5 tw-text-green-500" style="display:inline-block;vertical-align:middle"></i></b>
                                            <span class="custom-control-indicator"></span>
                                        </label>
                                    <?php } ?>
                                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><i data-lucide="book-open" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i> <?php echo $lang['add-title13'] ?></h4>
                                    <br>
                                    <div class="row">
                                            ...
                                            <div class="row row-shadow input-container"> 
                                              <div class="col-sm-12 col-md-6 col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                      <input type="text" onkeypress="return isNumberKey(event, this)" onblur="cdp_cal_final_total();" class="form-control form-control-sm" value="<?php echo $core->value_weight; ?>" name="price_lb" id="price_lb" style="border: 1px solid red;">
                                                    </div>
                                                 </div>
                                              </div>
                                              ...
                                              <div class="col-sm-12 col-md-6 col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                       <input type="text" onkeypress="return isNumberKey(event, this)" onblur="cdp_cal_final_total();" class="form-control form-control-sm is-invalid" value="100" name="insured_value" id="insured_value" style="border: 1px solid darkorange;">
                                                    </div>
                                              ...
                                              <div class="col-sm-12 col-md-6 col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                      <input type="text" onkeypress="return isNumberKey(event, this)" onblur="cdp_cal_final_total();" class="form-control form-control-sm" value="<?php echo $core->insurance; ?>" name="insurance_value" id="insurance_value" style="border: 1px solid darkorange;">
                                                    </div>
