            ...
            <div class="tw-bg-gradient-to-r tw-from-blue-600 tw-to-indigo-700 tw-rounded-2xl tw-shadow-lg tw-mx-4 tw-mt-4 tw-mb-6 tw-p-6 tw-flex tw-items-center tw-justify-between tw-flex-wrap tw-gap-4">
                <div class="tw-flex tw-items-center tw-gap-4">
                    <div class="tw-bg-white/20 tw-rounded-xl tw-p-3">
                        <i data-lucide="package-check" class="tw-w-7 tw-h-7 tw-text-white"></i>
                    </div>
                    <div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputcontact" class="control-label col-form-label"><?php echo $lang['langs_039'] ?> <i data-lucide="truck" class="tw-w-4 tw-h-4 tw-text-red-500" style="display:inline-block;vertical-align:middle"></i></label>
                                            <div class="input-group">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="invoice-item-table" class="table">
                                            <div align="right">
                                                <button type="button" data-toggle="modal" data-target="#myModalConsolidate" class="btn btn-outline-success"><i data-lucide="search" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i> Search Shipments</button>
                                            </div>
