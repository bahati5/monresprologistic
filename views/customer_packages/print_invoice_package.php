    ...
    <div id="page-wrap">
        ...
        <table id="items">
            ...
            foreach ($order_items as $row_item) {
                ...
                $sumador_total =  ($calculate_weight *  (float)$row->value_weight);

               $sumador_valor_declarado += (float)$row_item->order_item_declared_value;
                $sumador_fixed_charge += (float)$row_item->order_item_fixed_value;
                $max_fixed_charge += (float)$row_item->order_item_fixed_value;
            ...
            $total_impuesto_aduanero = ($total_peso * $row->tax_custom_tariffis_value) / 100;
