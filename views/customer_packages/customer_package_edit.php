        ...
        <div class="page-wrapper">
            ...
            <div class="tw-bg-gradient-to-r tw-from-blue-600 tw-to-indigo-700 tw-rounded-2xl tw-shadow-lg tw-mx-4 tw-mt-4 tw-mb-6 tw-p-6 tw-flex tw-items-center tw-justify-between tw-flex-wrap tw-gap-4">
                <div class="tw-flex tw-items-center tw-gap-4">
                    ...
                    <div>
                        <h1 class="tw-text-xl tw-font-bold tw-text-white tw-leading-tight"><?php echo $lang['messagesform35']; ?></h1>
                        <p class="tw-text-blue-100 tw-text-sm tw-mt-0.5"><?php echo $row_order->order_prefix . $row_order->order_no; ?></p>
                    </div>
                </div>
            </div>
                    ...
                    ?>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title"><i data-lucide="paperclip" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i> <?php echo $lang['leftorder16']; ?></h5>
                                        <hr>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="card-title">
                                                <i data-lucide="boxes" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle;color:#36bea6"></i>
