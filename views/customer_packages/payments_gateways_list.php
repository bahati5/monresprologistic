            ...
            <div class="tw-p-4 lg:tw-p-6 tw-space-y-4">
                <div class="tw-flex tw-flex-col sm:tw-flex-row sm:tw-items-center sm:tw-justify-between tw-gap-3">
                    <h1 class="tw-text-2xl tw-font-bold tw-text-gray-800">
                        <i data-lucide="package" class="tw-w-6 tw-h-6 tw-inline tw-mr-2"></i>
                        <?php echo $lang['left-menu-sidebar-5'] ?> | <?php echo $lang['leftorder141'] ?>
                    </h1>
                </div>
                    ...
                    <div class="tw-flex tw-flex-col md:tw-flex-row tw-gap-3 tw-mb-4">
                        <div class="tw-relative tw-flex-1">
                            ...
                            <input type="text" name="search" id="search" onkeyup="cdp_load(1);"
                                   ...
                                   placeholder="<?php echo $lang['left533020026'] ?>">
                        </div>
                        <select onchange="cdp_load(1);" id="gateway" name="gateway"
