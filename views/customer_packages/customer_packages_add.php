        ...
        <div class="page-wrapper">
            ...
            <div class="tw-bg-gradient-to-r tw-from-blue-600 tw-to-indigo-700 tw-rounded-2xl tw-shadow-lg tw-mx-4 tw-mt-4 tw-mb-6 tw-p-6 tw-flex tw-items-center tw-justify-between tw-flex-wrap tw-gap-4">
                <div class="tw-flex tw-items-center tw-gap-4">
                    ...
                    <div>
                        <h1 class="tw-text-xl tw-font-bold tw-text-white tw-leading-tight"><?php echo $lang['messagesform36']; ?></h1>
            ...
            <div class="tw-mx-4 tw-mb-6">
                <div class="tw-flex tw-items-center tw-justify-between tw-gap-2 tw-bg-white tw-rounded-xl tw-shadow-sm tw-p-3 tw-overflow-x-auto">
                    ...
                    <a href="#step-sender" class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-blue-50 tw-text-blue-700 tw-font-medium tw-text-xs tw-no-underline hover:tw-bg-blue-100 tw-transition tw-whitespace-nowrap">
                        ...
                        <?php echo $lang['langs_010'] ?? 'Expéditeur'; ?>
                    </a>
                    <div class="tw-h-px tw-w-8 tw-bg-gray-200 tw-flex-shrink-0"></div>
            ...
            <form method="post" id="invoice_form" name="invoice_form" enctype="multipart/form-data">
                ...
                <div class="container-fluid">
                    ...
                    <!-- ===== STEP 2: Expéditeur ===== -->
                    <div id="step-sender" class="tw-scroll-mt-20">
                    <div class="tw-flex tw-items-center tw-gap-2 tw-mb-3 tw-mt-2 tw-px-1">
                        <i data-lucide="user" class="tw-w-4 tw-h-4 tw-text-blue-600"></i>
                        <h2 class="tw-text-xs tw-font-semibold tw-text-gray-500 tw-uppercase tw-tracking-wider"><?php echo $lang['langs_010'] ?? 'Expéditeur'; ?></h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                        ...
                                        <label class="custom-control custom-checkbox" style="font-size: 18px; padding-left: 0px">
                                            ...
                                            <b> <?php echo $lang['leftorder14443']; ?> <i data-lucide="message-circle" class="tw-w-5 tw-h-5" style="display:inline-block;vertical-align:middle;color:#07bc4c"></i></b>
                                    ...
                                    ?>
                                        ...
                                        <label class="custom-control custom-checkbox" style="font-size: 18px; padding-left: 0px">
                                            ...
                                            <b>
                                                ...
                                                <i data-lucide="mail" class="tw-w-5 tw-h-5" style="display:inline-block;vertical-align:middle;color:#07bc4c"></i>
                                            </b>
                                            <span class="custom-control-indicator"></span>
                                        </label>
                                    <?php } ?> 
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="sum2"><i data-lucide="box" class="tw-w-4 tw-h-4 tw-mr-1" style="display:inline-block;vertical-align:middle"></i><strong> <?php echo $lang['left63'] ?></strong></label>
                                                <input type="text" class="form-control" name="tracking_purchase" id="tracking_purchase" placeholder="<?php echo $lang['left63'] ?>" style="border: 1px solid red;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="provider_purchase" id="provider_purchase" placeholder="<?php echo $lang['left65'] ?>" style="border: 1px solid red;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input onkeypress="return isNumberKey(event, this)" type="text" class="form-control" name="price_purchase" id="price_purchase" placeholder="<?php echo $lang['left67'] ?>" style="border: 1px solid red;">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <button type="button" id="openMultiFile" class="btn btn-default  pull-left  mb-4"> <i data-lucide="paperclip" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i> <?php echo $lang['leftorder16']; ?> </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div id="clean_files" class="hide">
                                            <button type="button" id="clean_file_button" class="btn btn-danger ml-3"> <i data-lucide="trash-2" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i> <?php echo $lang['leftorder17']; ?> </button>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="card-title">
                                                <i data-lucide="boxes" class="tw-w-5 tw-h-5" style="display:inline-block;vertical-align:middle;color:#36bea6"></i>
                                    ...
                                    <div class="col-md-3 text-left">
                                        <button type="button" onclick="addPackage()" name="add_rows" id="add_rows" class="btn btn-outline-dark"><i data-lucide="plus" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i> <?php echo $lang['left231'] ?></button>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top: 20px;">
                                        <div class="table-responsive " id="table-totals">
                                            ...
                                            <div  class="" id="row">
                                                <div class="col-md-6">
                                                    <h4 class="card-title">
                                                        <i data-lucide="briefcase" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle;color:#36bea6"></i>
                                                ...
                                                <div class="card-body">
                                                    <div class="text-right">
                                                        ...
                                                        <button type="submit" name="create_invoice" id="create_invoice" class="btn btn-success">
                                                            <i data-lucide="save" class="tw-w-4 tw-h-4" style="display:inline-block;vertical-align:middle"></i>
