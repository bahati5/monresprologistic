...
<head>
        <meta charset="utf-8" />
        <title>Acheter sur Amazon depuis le Madagascar et Livraison | Monrespro Logistics</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="keywords" content="achat amazon, livraison madagascar, achat fnac"> 
		<meta name="author" content="Monrespro">
		<meta name="description" content=" Achetez sur Amazon depuis le Madagascar avec facilité. Profitez d'une livraison rapide et d'un large choix de produits adaptés à vos besoins.">
        <!-- favicon -->
