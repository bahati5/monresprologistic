...
if (empty($_POST['id_delete']))
    ...
    $errors['id_delete'] = 'Please select shipment package';
...
if (empty($errors)) {
    ...
    $insert = cdp_deleteFullCourierpackage($data);


    if ($insert) {


        $messages[] = $lang['notification_shipment0888'] . $track_resulta;
        ...
        $db->bind(':order_id',  $_POST['id_delete']);
