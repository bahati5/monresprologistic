...
<div class="row">
    ...
    <div class="col-md-6">
        <h4 class=" pull-left"><b class="text-danger"> <?php echo $lang['billing'] ?></b> <span>#<?php echo $data->order_prefix . $data->order_no; ?></span></h4>
    ...
    <div class="col-md-4">
        <div class="pull-left">
            <h5> &nbsp;<b><?php echo $lang['modal-text20'] ?>
                </b></h5>
    ...
    <div class="col-md-12 pt-2">
        <div class="pull-left">
            <h5> &nbsp;<b> <?php echo $lang['modal-text18'] ?>
                </b></h5>
