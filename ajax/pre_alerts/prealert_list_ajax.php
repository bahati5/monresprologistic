						...
						<tr class="card-hovera">
							...
							<td align='center'>
								<div class="relative" style="position: relative;" x-data="{ open: false }">
									<button @click="open = !open" class="tw-px-3 tw-py-2 tw-text-gray-600 hover:tw-text-gray-900 hover:tw-bg-gray-100 tw-rounded-lg tw-transition-colors tw-duration-200" type="button">
									...
									<div x-show="open" 
										...
										class="absolute right-0 mt-2 w-56 tw-bg-white tw-rounded-xl tw-shadow-lg tw-border tw-border-gray-200" 
										style="z-index: 9999; overflow-y: auto; max-height: 200px;">
										<div class="tw-py-2">
											<a href="<?php echo $row->url_invoice; ?>" target="_blank" class="tw-flex tw-items-center tw-px-4 tw-py-3 tw-text-sm tw-text-gray-700 hover:tw-bg-gray-50 tw-transition-colors tw-duration-150">
												<i class="fa fa-search tw-w-4 tw-h-4 tw-text-gray-400 tw-mr-3"></i>
												<span><?php echo $lang['customer-packages-text3'] ?></span>
											</a>
											...
											if ($user->cdp_is_Admin()) {
												if ($row->is_package == 0) {
											?>
												<a href="customer_packages_add_from_prealert.php?id=<?php echo $row->pre_alert_id; ?>" class="tw-flex tw-items-center tw-px-4 tw-py-3 tw-text-sm tw-text-gray-700 hover:tw-bg-gray-50 tw-transition-colors tw-duration-150">
													<i class="ti-package tw-w-4 tw-h-4 tw-text-gray-400 tw-mr-3"></i>
													<span><?php echo $lang['customer-packages-text4'] ?></span>
												</a>
											<?php }
											}
											?>
