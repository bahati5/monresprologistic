	...
	<table id="file_export" class="table border table-striped table-bordered display dataTable" aria-describedby="file_export_info">
		<thead>
			<tr>
				...
				<th data-sort-ignore="true"><b><?php echo $lang['tools-methodpay1123'] ?></b></th>
				...
				<tr>
					...
					<td class="text-center">
						...
						?>
							...
							<a id="item_<?php echo $row->id; ?>" onclick="cdp_eliminar('<?php echo $row->id; ?>');" class="delete" data-rel="<?php echo $row->label; ?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-methodpay17'] ?>">
