...
if (empty($errors)) {
    ...
    if (!empty($_FILES['file_invoice']['name'])) {
        ...
        move_uploaded_file($_FILES["file_invoice"]["name"], $target_file);
    ...
    if ($insert) {
        ...
        $messages[] =  $lang['message_ajax_success_payment'];
        ...
        $db->bind(':notification_description', $lang['notification_shipment16']);
