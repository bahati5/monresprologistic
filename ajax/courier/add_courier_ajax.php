...
if (empty($errors)) {
    ...
    if ($shipment_id !== null) {
        ...
        // Función para enviar notificaciones WhatsApp
        ...
        // Enviar notificación WhatsApp al remitente si está habilitado
        if ($notify_whatsapp_sender) {
            sendWhatsAppNotification($sender_data, $shipment_id, 3);
        }
        
        // Enviar notificación WhatsApp al receptor si está habilitado
